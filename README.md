...
```javascript
IS_TOUCH_DEVICE = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-touch-device@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-touch-device@umd/bundle.js"></script>
```
