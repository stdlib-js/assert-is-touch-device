...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/assert-is-touch-device/tags). For example,

```javascript
IS_TOUCH_DEVICE = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-touch-device@v0.1.1-umd/browser.js' )
```
